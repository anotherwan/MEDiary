        ...
        <div className="home">
            <Row style={{'margin':'0px'}}>
                ...
                <Col m={2} className='m5' s={3}>
                  <div style={{'border-bottom':'solid black 2px', 'width': '100px'}}><h6>Head</h6></div>
                  <Link to="/region/head">
                    <img src={headHead} alt="Head" style={this.bubbleStyle}/>
                  </Link>
                </Col>
                <Col m={2} className='m5' s={3}>
                  <div style={{'border-bottom':'solid black 2px', 'width': '100px'}}><h6>Torso</h6></div>
                  <Link to="/region/torso">
                    <img src={torsoMan} alt="Torso" style={this.bubbleStyle}/>
                  </Link>
                </Col>
                <Col m={2} className='m5' s={3}>
                  <div style={{'border-bottom':'solid black 2px', 'width': '100px'}}><h6>Arms</h6></div>
                  <Link to="/region/arms">
                    <img src={armsArm} alt="Arms" style={this.bubbleStyle}/>
                  </Link>
                </Col>
                <Col m={2} className='m5' s={3}>
                  <div style={{'border-bottom':'solid black 2px', 'width': '100px'}}><h6>Legs</h6></div>
                  <Link to="/region/legs">
